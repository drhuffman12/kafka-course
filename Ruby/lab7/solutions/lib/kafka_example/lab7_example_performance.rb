...
module KafkaExample
  class Lab7Performance
    # TOPIC_DEFAULT = 'my_orders2'
    TOPICS = ['latency', 'throughput', 'reliability']
    CLIENT_ID_DEFAULT = 'lab7-producer'
    ...
    def generate_message
      ...
      {
        'latency' => producer_1,
        'throughput' => producer_0,
        'reliability' => producer_all
      }.each_pair do |topic, producer|
        val = rand_val
